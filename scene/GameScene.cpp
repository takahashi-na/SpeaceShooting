...
void GameScene::Initialize() {
	...
	// プレイヤー
	textureHandlePlayer_ = TextureManager::Load("player1.png");
	modelPlayer_ = Model::Create();
	worldTransformPlayer_.scale_ = {0.5f, 0.5f, 0.5f};
	worldTransformPlayer_.Initialize();

	// ビーム
	textureHandleBeam_ = TextureManager::Load("beam1.png");
	...
	// 敵
	textureHandleEnemy_ = TextureManager::Load("enemy1.png");
	...
	// タイトル(2Dスプライト)
	textureHandleTitle_ = TextureManager::Load("title1.png");
	...
	spriteGameClear_ = Sprite::Create(textureHandleGameClear_, {0, 100});
...
void GameScene::GamePlayStart() {
	...
	sceneMode_ = 0;
	gameScore_ = 0;
	gameTimer_ = 0;       // 点滅演出に使ってるタイマー
	playerTimer_ = 0;     // 点滅演出に使ってるタイマー
